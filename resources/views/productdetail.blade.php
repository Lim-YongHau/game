...
@section('content')  
	<div class="row" align="center">
        ...
        <div class="col-md-5"><img src="{{ asset('images/') }}/{{$product->image}}" alt="" width="50%" class="img-fluid"> </div>
            <div class="col-md-5">
                <form action="{{ route('add.to.cart') }}" method="post">
                           {{ csrf_field() }} 
                    <h5 class="card-title alert alert-warning rounded-pill">{{$product->name}}</h5>
